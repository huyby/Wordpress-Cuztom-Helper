...
class Cuztom_Field_Image extends Cuztom_Field
{
	...
	function _output( $value )
	{
		...
		$output .= ( ! empty( $value ) ? sprintf( '<a href="#" class="js-cuztom-remove-media cuztom-remove-media">%s</a>', __( isset($this->args["repeatable_remove_label"]) ? $this->args["repeatable_remove_label"] : 'Remove current image', 'cuztom' ) ) : '' );
